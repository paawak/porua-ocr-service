...
public class OCRSubmissionController {
    ...
    public List<OcrWordEntity> submitPageAndAnalyzeWords(@RequestParam("bookId") final Long bookId, @RequestParam("pageNumber") final Integer pageNumber, @RequestParam("image") final MultipartFile image)
